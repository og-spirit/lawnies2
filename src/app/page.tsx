    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <section className="relative overflow-hidden bg-white">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at center, rgba(52,211,153,0.35), transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
      ...
      <section className="bg-white border-y border-slate-100 py-16">
        <div className="w-full max-w-lg mx-auto px-6">
          ...
          <div className="mt-8 text-center">
            <p className="text-3xl font-semibold mb-1" style={{ color: "#1a1a1a" }}>
              Stop the loss.
            </p>
            <div className="mb-5">
              ...
              <div className="space-y-1">
                <p className="text-base font-medium" style={{ color: "#222" }}>
        ...
        <div className="w-full max-w-4xl mx-auto px-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-10">
            {[
              ...
              <div
                key={step}
                className="relative bg-white rounded-2xl p-6 border border-emerald-100 shadow-sm"
              >
        ...
        <div className="w-full max-w-lg mx-auto px-6">
          ...
          <ul className="space-y-3 mb-8">
            {[
              ...
              <li
                key={item}
                className="flex justify-center items-center bg-emerald-100 border border-emerald-300 rounded-xl px-5 py-4"
              >
          ...
          <div className="text-center space-y-1">
            <p className="text-slate-800 font-bold">
              It only offers times that make sense for you.
            </p>
        ...
        <div className="w-full max-w-2xl mx-auto px-6 text-center">
          ...
          <ul className="space-y-4 text-left max-w-md mx-auto">
            {[
              ...
              <li
                key={item}
                className="flex justify-center items-start bg-emerald-50 border border-emerald-100 rounded-xl px-5 py-4"
              >
      ...
      <footer className="bg-slate-950 py-6 text-center">
        ...
        <p className="text-slate-600 text-xs">
          ...
          <a
            href="mailto:stefan@lawnies.com.au?subject=Basic%20Web%20Link%20Option%20Enquiry"
