...
const SignupPage = () => {
  ...
  const scrollToForm = () => {
    const formSection = document.getElementById('activation-form');
    if (formSection) {
      ...
      <main className="px-6 py-12 md:py-16">
        <div className="w-full max-w-2xl mx-auto space-y-10 md:space-y-12">
          ...
          <section className="bg-emerald-50 border border-emerald-100 rounded-2xl p-6 md:p-8">
            <h2 className="text-2xl font-black text-slate-900 mb-5">You&apos;re getting:</h2>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 md:p-8 text-center">
            <h2 className="text-2xl font-black text-slate-900 mb-6">Your Booking Protection</h2>
            ...
            <div className="space-y-1">
              <p className="text-base md:text-lg font-semibold text-slate-800">One-time professional setup</p>
              <p className="text-3xl md:text-4xl font-bold text-slate-800">$597 + GST</p>
              <p className="text-sm text-slate-500 font-medium">Includes your first month</p>
            </div>

            <p className="mt-6 text-sm font-semibold text-slate-500">No lock-in contracts. Cancel anytime.</p>
            <div className="mt-5">
              <button
                type="button"
          ...
          <section className="text-center">
            <p className="text-xs text-slate-500">Prefer to talk it through first?</p>
            <p className="text-xs text-slate-500 mt-1">Call us on 0431 847 833</p>
          </section>

          <section id="activation-form" className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 md:p-8 scroll-mt-28">
